...
register_borrow_routes(bp, 'equipment', Equipment)
register_duplicate_routes(bp, 'equipment', Equipment)
register_sticker_routes(bp, Equipment, lambda item: get_sticker_lines('equipment', item))
